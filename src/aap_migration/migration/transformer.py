...
class DataTransformer:
    ...
    # Example: {"organization": "organizations", "inventory": "inventory"}
    ...
    def transform_resource(
        ...
        Args:
            resource_type: Type of resource (e.g., 'inventory', 'job_templates')
...
class InventoryTransformer(DataTransformer):
    ...
    def _apply_specific_transformations(
        ...
        Args:
            data: Inventory data
            resource_type: Resource type (should be 'inventory')
...
class WorkflowTransformer(DataTransformer):
    ...
    def _apply_specific_transformations(
        ...
        if "nodes" in data:
            ...
            data["_workflow_job_template_nodes"] = data.pop("nodes")
...
class InventoryGroupTransformer(DataTransformer):
    ...
    def _apply_specific_transformations(
        ...
        Args:
            data: Inventory group data
            resource_type: Resource type (should be 'groups')
...
class RoleDefinitionTransformer(DataTransformer):
    ...
    async def populate_target_id_from_target(
        ...
        try:
            ...
            if resources:
                target_id = resources[0]["id"]
                state.mark_completed("role_definitions", source_id, target_id, source_name=name)
                logger.info(
...
# Resource dependency map for continuity validation (REQ-006)
...
TRANSFORMER_CLASSES: dict[str, type[DataTransformer]] = {
    ...
    "groups": InventoryGroupTransformer,
...
def create_transformer(
    ...
    **kwargs: Any,
    ...
    transformer_cls = TRANSFORMER_CLASSES.get(canonical_type, DataTransformer)
